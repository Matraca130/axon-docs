...
## Decisiones específicas de QZ-04
| Fecha | Decisión | Contexto |
|-------|----------|----------|
| 2026-03-25 | BKT tracking es fire-and-forget | Las llamadas a bktApi se disparan sin await para no bloquear la UI |
| 2026-03-25 | Máquina de estados de 5 fases es sagrada | Cualquier cambio requiere revalidar todas las transiciones |
